...
leaflet.Icon.Glyph = leaflet.Icon.extend({
	options: {
		iconSize: [25, 41],
		iconAnchor:  [12, 41],
		popupAnchor: [1, -34],
	...
	changeColor: function(){
		this.options.className = "r50";
		console.log(this.options.className)
		this.div.classList.add("r50");
	},
	...
	_createGlyph: function() {
		...
		var span = leaflet.DomUtil.create('span', options.prefix + ' ' + glyphClass);
	...
	_setIconStyles: function (div, name) {
		if (name === 'shadow') {
			return leaflet.Icon.prototype._setIconStyles.call(this, div, name);
		}

		var options = this.options,
		    size = leaflet.point(options['iconSize']),
